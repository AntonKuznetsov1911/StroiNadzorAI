...
REGULATIONS_CATEGORIES = {
    "Конструкции": {
        "icon": "🏗️",
        "regulations": [
            "СП 63.13330.2018",  # Бетонные
            "СП 16.13330.2017",  # Стальные
            "СП 64.13330.2017",  # Деревянные
            "СП 70.13330.2012",  # Несущие
    ...
    "Основания и фундаменты": {
        ...
        "regulations": [
            ...
            "СП 24.13330.2021",  # Свайные
            "СП 50-101-2004",    # Проектирование оснований
        ]
    },
    "Ограждающие конструкции": {
        ...
        "regulations": [
            ...
            "СП 23-101-2004",    # Тепловая защита
    ...
    "Пожарная безопасность": {
        "icon": "🔥",
        "regulations": [
            "СП 2.13130.2020",   # Огнестойкость
            "СП 4.13130.2013",   # Ограничение пожара
        ]
    },
    "Контроль качества": {
        "icon": "✅",
        "regulations": [
            "ГОСТ 10180-2012",   # Прочность бетона
            "ГОСТ 22690-2015",   # Мех. методы
            "СП 48.13330.2019",  # Организация строительства
            "ГОСТ 31937-2011",   # Обследование
        ]
    },
    "Обследование": {
        "icon": "🔍",
        "regulations": [
            "СП 13-102-2003",        # Обследование конструкций
            "СП 255.1325800.2016",   # Эксплуатация
        ]
    },
    "Доступность": {
        "icon": "♿",
        "regulations": [
            "СП 59.13330.2020",  # Маломобильные группы
        ]
    }
}
...
def create_regulations_category_menu():
    ...
    for category, data in REGULATIONS_CATEGORIES.items():
        icon = data['icon']
        count = len(data['regulations'])
        buttons.append([InlineKeyboardButton(
            f"{icon} {category} ({count})",
            callback_data=f"reg_cat_{category}"
        )])
...
def get_regulations_by_category(category):
    ...
    if category == "all":
        ...
        all_regs = []
        for data in REGULATIONS_CATEGORIES.values():
            all_regs.extend(data['regulations'])
        return all_regs

    return REGULATIONS_CATEGORIES.get(category, {}).get('regulations', [])
