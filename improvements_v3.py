...
CALCULATORS = {
    ...
    "winter_heating": {
        ...
        "description": "Прогрев бетона в зимних условиях",
        "icon": "❄️"
    },
    "math": {
        "name": "🧮 Математический",
    ...
    "brick": {
        "name": "🧱 Кирпич/блоки",
        "description": "Количество, раствор, проёмы",
        "icon": "🧱"
    },
    "tile": {
        "name": "🔲 Плитка",
        "description": "Количество, клей, затирка",
        "icon": "🔲"
    },
    "paint": {
        "name": "🎨 Краска",
        "description": "Расход, слои, грунтовка",
        "icon": "🎨"
    },
    "wall_area": {
        "name": "📐 Площадь стен",
        "description": "Для покраски и обоев",
        "icon": "📐"
    },
    "roof": {
        "name": "🏠 Кровля",
        "description": "Площадь, листы, утеплитель",
        "icon": "🏠"
    },
    "plaster": {
        "name": "🧱 Штукатурка",
        "description": "Расход, толщина слоя",
        "icon": "🧱"
    },
    "wallpaper": {
        "name": "🖼️ Обои",
        "description": "Рулоны, клей, раппорт",
        "icon": "🖼️"
    },
    "laminate": {
        "name": "🪵 Ламинат",
        "description": "Доски, подложка, плинтус",
        "icon": "🪵"
    },
    "insulation": {
        "name": "🧊 Утеплитель",
        "description": "Количество, толщина",
        "icon": "🧊"
    },
    "foundation": {
        "name": "⚓ Фундамент",
        "description": "Объём, арматура, опалубка",
        "icon": "⚓"
    },
    "stairs": {
        "name": "🪜 Лестница",
        "description": "Ступени, косоур, материалы",
        "icon": "🪜"
    },
    "drywall": {
        "name": "📐 Гипсокартон",
        "description": "Листы, профили, крепёж",
        "icon": "📐"
    },
    "earthwork": {
        "name": "🚜 Земляные работы",
        "description": "Объём, техника, стоимость",
        "icon": "🚜"
    },
    "labor": {
        "name": "👷 Трудозатраты",
        "description": "Нормы, рабочие, стоимость",
        "icon": "👷"
    }
}
