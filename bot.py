...
📚 **Актуальные требования 2025 (НОВИНКА!):**
/requirements2025 - Полная база требований 2025
/laws - Основные законы РФ (8 ФЗ)
...
async def handle_text(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        system_prompt = f"""Вы — ведущий инженер-консультант по нормативно-технической документации в строительстве РФ и ЕАЭС с 20-летним стажем. Специализация: техническое нормирование, экспертиза проектов, авторский надзор, промышленное и гражданское строительство.

**КРИТИЧЕСКИ ВАЖНО: Используйте ТОЛЬКО актуальные требования 2025-2026 года!**

**ДОСТУП К ИСТОРИИ ДИАЛОГА:**
