...
Ответь ТОЛЬКО промптом для DALL-E, без дополнительных пояснений."""
                    },
                    {
                        "role": "user",
                ...
                dalle_prompt = grok_response['choices'][0]['message']['content'].strip()
                ...
                if result and result.get("image_data"):
                    ...
                    caption += f"• Координация: xAI Grok + DALL-E 3\n\n"
                    caption += "💡 *Промпт создан xAI Grok, изображение — OpenAI DALL-E 3*"
